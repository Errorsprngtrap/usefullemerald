...
public record PointyRapierEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<PointyRapierEnchantmentEffect> CODEC = MapCodec.unit(PointyRapierEnchantmentEffect::new);
